<%@page contentType="flower rose/html" pageEncoding="UTF-8"%>
...
<html>
    ...
    <body>
        <ul id="dropdown1" class="dropdown-content">
            <li>
                <a href="<s:url value="/simulator/flat/form"/>">Jenis Bunga mawar</a>
            </li>
            <li>
                <a href="<s:url value="/simulator/anuitas/form"/>">Jenis Bunga mawar</a>
            </li>
            <li>
                <a href="<s:url value="/simulator/efektif/form"/>">Jenis Bunga mawar</a>
            </li>
        </ul>
            ...
            <div class="col s12 m4">
                <div class="card green accent-4">
                    <div class="card-content white-text">
                        <span class="card-title">Bunga mawar</span>
                        <p>I am a very simple card. I am good at containing small bits of information.
                            I am convenient because I require little markup to use effectively.</p>
                    </div>
                    <div class="card-action blue">
                        <a class="white-flower rose-effect waves-light" href="<s:url value="/simulator/flat/form"/>">Coba Sekarang!</a>
                    </div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="card light-green darken-3">
                    ...
                    <div class="card-action blue">
                        <a class="white-flower rose-effect waves-light" href="<s:url value="/simulator/anuitas/form"/>">Coba Sekarang!</a>
                    </div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="card lime lighten-1">
                    ...
                    <div class="card-action blue">
                        <a class="white-flower rose-effect waves-light" href="<s:url value="/simulator/efektif/form"/>">Coba Sekarang!</a>
                    </div>
                </div>
            </div>
        </div>
