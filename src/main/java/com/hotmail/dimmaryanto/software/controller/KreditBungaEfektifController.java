...
@Controller
@RequestMapping("/simulator/efektif")
public class KreditBungaEfektifController {
    ...
    public ModelAndView proses(@ModelAttribute Kredit f) {
        ...
        for (Integer i = 1; i <= f.getJangka(); i++) {
            BungaJenisEfektif ft = new BungaJenisEfektif(i, f.getPlafond(), f.getJangka(), f.getBunga());
